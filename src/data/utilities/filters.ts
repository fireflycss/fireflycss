export = {
    ...
    dropShadow: {
        ...
        keys: {
            custom: "var(--ff-drop-shadow-offset-x, 0) var(--ff-drop-shadow-offset-y, 1px) var(--ff-drop-shadow-blur, 3px)  var(--ff-drop-shadow-color, rgba(0, 0, 0, 0.1))",
            //todo add
        },
    },
    dropShadowColor: {
    ...
    backdropDropShadow: {
        ...
        keys: {
            custom: "var(--ff-backdrop-shadow-offset-x, 0) var(--ff-backdrop-shadow-offset-y, 1px) var(--ff-backdrop-shadow-blur, 3px)  var(--ff-backdrop-shadow-color, rgba(0, 0, 0, 0.1))",
            //todo add
        },
    },
